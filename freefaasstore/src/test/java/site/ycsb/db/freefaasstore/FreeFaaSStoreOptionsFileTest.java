...
public class FreeFaaSStoreOptionsFileTest {

  @Rule
  public TemporaryFolder tmpFolder = new TemporaryFolder();

  private FreeFaaSStoreClient instance;

  @Test
  public void loadOptionsFromFile() throws Exception {
    final String optionsPath = FreeFaaSStoreClient.class.getClassLoader().getResource("testcase.ini").getPath();
  ...
  private void initDbWithOptionsFile(final String dbPath, final String optionsPath) throws Exception {
    instance = new FreeFaaSStoreClient();

    final Properties properties = new Properties();
    properties.setProperty(FreeFaaSStoreClient.PROPERTY_ROCKSDB_DIR, dbPath);
    properties.setProperty(FreeFaaSStoreClient.PROPERTY_ROCKSDB_OPTIONS_FILE, optionsPath);
